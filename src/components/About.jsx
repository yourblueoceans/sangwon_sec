    ...
    <section id="about" className="py-32 relative bg-bg-main overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-24 w-full">
          ...
          <div className="glass-panel rounded-[3rem] p-8 md:p-12 bg-white/70 shadow-xl border border-white/50 w-full overflow-hidden group/track">
              ...
              <div className="animate-marquee whitespace-nowrap flex gap-20 px-4" style={{ animationDuration: '80s' }}>
                {techStack.map((tech, index) => (
                  <div key={index} className="flex flex-col items-center gap-4 min-w-[100px] transition-all duration-300">
                    ...
                    />
                    <span className="text-xs font-bold text-slate-400 group-hover/track:text-slate-800 transition-colors uppercase tracking-wider">
                      {tech.name}
                    </span>
                  </div>
                ))}
