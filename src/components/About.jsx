...
// 회사 로고(아이콘) 추가
const experience = [
  { role: '교육생 (클라우드 보안)', company: '한국폴리텍대학', period: '2025.03 - 2026.02 (예정)', desc: "총 1,200시간. AWS/Linux 기반 보안 인프라 구축. 캡스톤 프로젝트 팀장으로 'LOCKUMENT' 개발 및 금상 수상.", logo: 'mdi:school', color: 'text-blue-600', bg: 'bg-blue-100' },
  { role: '개인사업자 (해외구매대행)', company: '스마트스토어 운영', period: '2024.01 - 현재', desc: '상품 소싱부터 통관, CS까지 이커머스 전 과정 1인 운영. 고객 클레임 대응 및 프로세스 관리.', logo: 'mdi:storefront', color: 'text-green-600', bg: 'bg-green-100' },
  { role: 'Passenger Traffic Agent', company: '대한항공 (San Francisco)', period: '2023.02 - 2023.08', desc: '공항 현장 운영 및 위기 관리. CBP 인터뷰 통역 지원, 태풍 결항 시 승객 안내 및 대체편 조율.', logo: 'mdi:airplane', color: 'text-sky-600', bg: 'bg-sky-100' },
  { role: 'Pharmacy Clerk', company: 'Apotheco Pharmacy (USA)', period: '2022.03 - 2023.01', desc: '처방전 접수 및 전산 관리. 약품 재고 관리 및 배송 포장 업무 수행.', logo: 'mdi:pill', color: 'text-red-500', bg: 'bg-red-100' },
  { role: 'Manager (Tech Sales)', company: 'Computer Ahnex (LA)', period: '2021.01 - 2021.08', desc: 'PC 조립 및 수리, 보안 S/W 기술 영업. 고객 맞춤형 견적 상담 및 매장 관리.', logo: 'mdi:monitor', color: 'text-purple-600', bg: 'bg-purple-100' },
  { role: '공동 사장', company: '하얀책상 4호점 (Cafe)', period: '2017.05 - 2018.03', desc: '매장 운영 총괄 및 마케팅 기획. 매출 관리 및 고객 서비스 품질 유지.', logo: 'mdi:coffee', color: 'text-amber-700', bg: 'bg-amber-100' },
  { role: 'Research Team Leader', company: 'LKSTC (Laos)', period: '2015.02 - 2016.09', desc: '현지 시장 조사 및 데이터 분석. 프로젝트 제안서 작성 및 현지 파트너 협업 조율.', logo: 'mdi:map-search', color: 'text-teal-600', bg: 'bg-teal-100' },
];
...
const CertCard = ({ cert }) => {
  ...
  return (
    <motion.div
      // Scale 제거: 텍스트 선명도 유지, 메인 카드만 그림자 펄스
      animate={
        isMain
          ? {
              boxShadow: [
    ...
    >
      {isMain && (
        <div className="absolute inset-0 bg-[conic-gradient(from_var(--angle),transparent_20%,#F59E0B_50%,transparent_80%)] animate-border-spin" style={{ '--angle': '0deg' }} />
      )}
