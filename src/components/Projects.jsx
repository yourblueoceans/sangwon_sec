...
const projectData = [
  {
    ...
    docs: [
      { name: '요구사항 정의서 v1.0', url: '#' },
      { name: 'WBS 및 일정 계획', url: '#' },
      { name: '아키텍처 설계서', url: '#' },
      { name: '테이블 명세서 (ERD)', url: '#' },
      { name: 'API 명세서', url: '#' },
      { name: '테스트 시나리오 및 결과', url: '#' },
      { name: '보안성 검토 보고서', url: '#' },
      { name: '최종 완료 보고서', url: '/sangwon_sec/assets/lockument.pdf' },
    ],
    gallery: ['/sangwon_sec/assets/project-lockument.png'],
  ...
  },
  {
    ...
    results: ['방화벽 정책 12종 적용', 'Kibana 실시간 모니터링', 'VLAN 기반 망분리'],
  },
  {
    id: 'webvuln',
    ...
    docs: [{ name: '최종 보고서', url: '/sangwon_sec/assets/web vuln.pdf' }],
    gallery: ['/sangwon_sec/assets/project-webvuln.png'],
    ...
    results: ['High Risk 취약점 100% 조치', '관리자 페이지 접근 통제', '시큐어 코딩 가이드 수립'],
  },
];
